	...
	public function actionLogout()
	{
	 ...
	 protected function getUserComment($data,$row)
     {
		...
		if ($data->comment == 'pending'){
			...
			$theCellValue="Vous vous êtes désinscrit";
		} 
		else if ($data->comment == 'deleted'){
			$theCellValue="Vous avez été supprimé de ce cours";
		} 
		return $theCellValue;    
    }  
}